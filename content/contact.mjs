...
<div class="contact-heading"><p class="eyebrow">Residential & commercial · Central Texas</p><h1>Let’s talk about<br>your project.</h1><p>Tell us about your property and the improvements you have in mind. From the first conversation to the finishing details, we’re ready to help.</p></div>
<div class="contact-layout"><aside class="contact-details" aria-label="Contact options"><h2 class="eyebrow">Start a conversation</h2><a class="contact-phone" href="tel:+17373009848" aria-label="Call Verde at 737-300-9848">737-300-9848</a><div class="contact-method"><span>Email</span><a href="mailto:hello&#64;verdelandscapes&#46;com">hello&#64;verdelandscapes&#46;com</a></div><div class="contact-commercial"><h3>Planning a commercial project?</h3><p>Include your company and project scope. You can email plans, bid documents, or photographs directly to our team.</p></div></aside>
<div class="inquiry-panel"><h2>Tell us what you have in mind.</h2><p class="form-intro">Fields marked * are required.</p>
<form action="https://formsubmit.co/hello&#64;verdelandscapes&#46;com" method="POST" class="inquiry-form">
